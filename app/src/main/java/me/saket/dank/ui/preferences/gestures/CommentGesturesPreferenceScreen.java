...
public class CommentGesturesPreferenceScreen extends RelativeLayout implements UserPreferenceNestedScreen {

  private Toolbar toolbar;

  public CommentGesturesPreferenceScreen(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
  }
